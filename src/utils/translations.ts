export const translations = {
  ...
  // ── Kannada (Coastal Karnataka — Primary Local Language) ──────────────────
  kn: {
    appTitle: "ರೈತರಿಗಾಗಿ ಲೈವ್ ಮಾರುಕಟ್ಟೆ ದರಗಳು",
    weather: "ಹವಾಮಾನ",
    CropCare: "ಬೆಳೆ ಆರೈಕೆ",
    searchPlaceholder: "ಸರಕು, ರಸಗೊಬ್ಬರ, ಕೀಟನಾಶಕ ಹುಡುಕಿ...",
    ...
    liveDataStatus: "ಲೈವ್ ಡೇಟಾ ಸ್ಥಿತಿ",
    active: "ಸಕ್ರಿಯ",
    lastUpdated: "ಕೊನೆಯ ನವೀಕರಣ",
    nextRefresh: "ಮುಂದಿನ ರಿಫ್ರೆಶ್",
    minutes: "ನಿಮಿಷ",
    ...
    fertilizerRates: "ರಸಗೊಬ್ಬರ ದರಗಳು",
    all: "ಎಲ್ಲ",
    organic: "ಸಾವಯವ",
    inorganic: "ಅಸಾವಯವ",
    unit: "ಘಟಕ",
    ...
    use: "ಬಳಕೆ",
    benefits: "ಪ್ರಯೋಜನಗಳು",
    farmingEquipment: "ಕೃಷಿ ಸಾಧನಗಳು",
    popularBrands: "ಜನಪ್ರಿಯ ಬ್ರ್ಯಾಂಡ್‌ಗಳು",
    pesticideRates: "ಕೀಟನಾಶಕ ದರಗಳು",
    activeIngredient: "ಸಕ್ರಿಯ ಘಟಕ",
    ...
    describeQuery: "ನಿಮ್ಮ ಪ್ರಶ್ನೆ ಅಥವಾ ಸಮಸ್ಯೆ ವಿವರಿಸಿ",
    submit: "ಸಲ್ಲಿಸಿ",
    priceCharts: "ಬೆಲೆ ಚಾರ್ಟ್‌ಗಳು",
    fertilizerPrices: "ರಸಗೊಬ್ಬರ ಬೆಲೆಗಳು (₹/50ಕಿ.ಗ್ರಾ.)",
    pesticidePrices: "ಕೀಟನಾಶಕ ಬೆಲೆಗಳು (₹/ಲಿ. ಅಥವಾ ₹/ಕಿ.ಗ್ರಾ.)",
    insecticide: "ಕೀಟನಾಶಕ",
    fungicide: "ಶಿಲೀಂಧ್ರನಾಶಕ",
    herbicide: "ಕಳೆ ನಾಶಕ",
    selectDataSection: "ಡೇಟಾ ವಿಭಾಗ ಆಯ್ಕೆ ಮಾಡಿ",
    browseData: "ಡೇಟಾ ಬ್ರೌಸ್ ಮಾಡಿ",
    selectDataToView: "ನೋಡಲು ಡೇಟಾ ಆಯ್ಕೆ ಮಾಡಿ",
    selectDataToViewDesc: "ವಿವರವಾದ ಮಾಹಿತಿ ನೋಡಲು ಮಂಡಿ ದರಗಳು, ರಸಗೊಬ್ಬರ, ಕೀಟನಾಶಕ ಅಥವಾ ಸಾಧನ ಆಯ್ಕೆ ಮಾಡಿ",
    mandiRatesDesc: "ಕೃಷಿ ಸರಕುಗಳ ಲೈವ್ ಮಾರುಕಟ್ಟೆ ಬೆಲೆಗಳು",
    fertilizerRatesDesc: "ಪ್ರಸ್ತುತ ರಸಗೊಬ್ಬರ ದರಗಳು ಮತ್ತು ಸಬ್ಸಿಡಿ ಮಾಹಿತಿ",
    pesticideRatesDesc: "ಕೀಟನಾಶಕ ದರಗಳು ಮತ್ತು ಸಕ್ರಿಯ ಘಟಕಗಳು",
    farmingEquipmentDesc: "ಕೃಷಿ ಸಾಧನ ಮತ್ತು ಯಂತ್ರಗಳ ಬೆಲೆಗಳು",
    cropCareTitle: "ಬೆಳೆ ಆರೈಕೆ ಮಾರ್ಗದರ್ಶಿ",
    cropCareSubtitle: "ರಸಗೊಬ್ಬರ, ಕೀಟನಾಶಕ ಮತ್ತು ರೋಗ ನಿಯಂತ್ರಣಕ್ಕಾಗಿ ತಜ್ಞ ಶಿಫಾರಸುಗಳು",
    overview: "ಅವಲೋಕನ", season: "ಋತು", temperature: "ತಾಪಮಾನ", rainfall: "ಮಳೆ",
    fertilizers: "ರಸಗೊಬ್ಬರ", pesticides: "ಕೀಟನಾಶಕ", diseases: "ರೋಗಗಳು",
    growthStages: "ಬೆಳವಣಿಗೆ ಹಂತಗಳು", generalTips: "ಸಾಮಾನ್ಯ ಸಲಹೆಗಳು",
    selectCropToStart: "ಪ್ರಾರಂಭಿಸಲು ಬೆಳೆ ಆಯ್ಕೆ ಮಾಡಿ",
    selectCropDescription: "ವಿವರವಾದ ಆರೈಕೆ ಶಿಫಾರಸುಗಳನ್ನು ನೋಡಲು ಮೇಲಿನ ಡ್ರಾಪ್‌ಡೌನ್‌ನಿಂದ ಬೆಳೆ ಆಯ್ಕೆ ಮಾಡಿ.",
    selectCrop: "ಬೆಳೆ ಆಯ್ಕೆ ಮಾಡಿ", cropInfo: "ಬೆಳೆ ಮಾಹಿತಿ", soilType: "ಮಣ್ಣಿನ ಪ್ರಕಾರ",
    phRange: "pH ವ್ಯಾಪ್ತಿ", scientificName: "ವೈಜ್ಞಾನಿಕ ಹೆಸರು",
    fertilizerRecommendations: "ರಸಗೊಬ್ಬರ ಶಿಫಾರಸು", pesticideRecommendations: "ಕೀಟನಾಶಕ ಶಿಫಾರಸು",
    diseasePrevention: "ರೋಗ ತಡೆಗಟ್ಟುವಿಕೆ ಮತ್ತು ನಿರ್ವಹಣೆ",
    dosage: "ಪ್ರಮಾಣ", applicationMethod: "ಅಪ್ಲಿಕೇಶನ್ ವಿಧಾನ", timing: "ಸಮಯ",
    npkRatio: "NPK ಅನುಪಾತ", type: "ಪ್ರಕಾರ", activeingredient: "ಸಕ್ರಿಯ ಘಟಕ",
    targetPests: "ಗುರಿ ಕೀಟಗಳು", waitingPeriod: "ನಿರೀಕ್ಷಣಾ ಅವಧಿ",
    biopesticide: "ಜೈವಿಕ ಕೀಟನಾಶಕ", bioFertilizer: "ಜೈವಿಕ ರಸಗೊಬ್ಬರ",
    fungal: "ಶಿಲೀಂಧ್ರ", bacterial: "ಬ್ಯಾಕ್ಟೀರಿಯಾ", viral: "ವೈರಲ್",
    nematode: "ನೆಮಟೋಡ್", severity: "ತೀವ್ರತೆ"
  },

  // ── Tulu (Coastal Karnataka — Secondary Local Language) ───────────────────
  tulu: {
    appTitle: "ರೈತೆರೆಗ್ ಲೈವ್ ಮಾರ್ಕೆಟ್ ದರ",
    weather: "ಮಳೆ-ಬೆಳೆ",
    CropCare: "ಬೆಳೆ ಜಾಗ್ರತೆ",
    searchPlaceholder: "ಸರಕು, ಗೊಬ್ಬರ ಇಲ್ಲಾ ಔಷಧಿ ತಪ್ಪಡ್...",
    selectLocation: "ಸ್ಥಳ ಆರಾನೆ",
    state: "ರಾಜ್ಯ",
    district: "ಜಿಲ್ಲೆ",
    market: "ಮಾರ್ಕೆಟ್",
    selectState: "ರಾಜ್ಯ ಆರಾನೆ",
    selectDistrict: "ಜಿಲ್ಲೆ ಆರಾನೆ",
    selectMarket: "ಮಾರ್ಕೆಟ್ ಆರಾನೆ",
    liveDataStatus: "ಲೈವ್ ಡೇಟಾ ಸ್ಥಿತಿ",
    active: "ಸಕ್ರಿಯ",
    ...
    min: "ಕಮ್ಮಿ",
    max: "ಜಾಸ್ತಿ",
    noChange: "ಬದಲಾವಣೆ ಇಜ್ಜಿ",
    fertilizerRates: "ಗೊಬ್ಬರ ದರ",
    all: "ಎಲ್ಲ",
    organic: "ಸಾವಯವ",
    inorganic: "ರಾಸಾಯನಿಕ",
    unit: "ಘಟಕ",
    ...
    use: "ಬಳಕೆ",
    benefits: "ಫಾಯಿದೆ",
    farmingEquipment: "ಕೃಷಿ ಉಪಕರಣ",
    popularBrands: "ಜನಪ್ರಿಯ ಬ್ರ್ಯಾಂಡ್",
    pesticideRates: "ಔಷಧಿ ದರ",
    activeIngredient: "ಸಕ್ರಿಯ ಘಟಕ",
    governmentSchemes: "ಸರ್ಕಾರಿ ಯೋಜನೆ",
    eligibility: "ಅರ್ಹತೆ",
    benefit: "ಫಾಯಿದೆ",
    viewDetails: "ವಿವರ ನೋಡ್",
    helpDesk: "ಸಹಾಯ ಕೇಂದ್ರ",
    submitQuery: "ಪ್ರಶ್ನೆ ಕೊರ್",
    name: "ಪೇರ್",
    email: "ಇಮೇಲ್",
    query: "ಪ್ರಶ್ನೆ",
    enterName: "ನಿಕುಲೆ ಪೇರ್ ಬರಿ",
    enterEmail: "ನಿಕುಲೆ ಇಮೇಲ್ ಬರಿ",
    describeQuery: "ನಿಕುಲೆ ಪ್ರಶ್ನೆ ಇಲ್ಲಾ ತೊಂದರೆ ಹೇಳ್",
    submit: "ಕೊರ್",
    priceCharts: "ಬೆಲೆ ಚಾರ್ಟ್",
    fertilizerPrices: "ಗೊಬ್ಬರ ಬೆಲೆ (₹/50ಕಿ.ಗ್ರಾ.)",
    pesticidePrices: "ಔಷಧಿ ಬೆಲೆ (₹/ಲಿ. ಇಲ್ಲಾ ₹/ಕಿ.ಗ್ರಾ.)",
    insecticide: "ಕೀಟನಾಶಕ",
    fungicide: "ಶಿಲೀಂಧ್ರನಾಶಕ",
    herbicide: "ಕಳೆ ನಾಶಕ",
    selectDataSection: "ಡೇಟಾ ವಿಭಾಗ ಆರಾನೆ",
    browseData: "ಡೇಟಾ ನೋಡ್",
    selectDataToView: "ನೋಡುಂಡ ಡೇಟಾ ಆರಾನೆ",
    selectDataToViewDesc: "ಮಂಡಿ ದರ, ಗೊಬ್ಬರ, ಔಷಧಿ ಇಲ್ಲಾ ಉಪಕರಣ ಆರಾನೆ",
    mandiRatesDesc: "ಕೃಷಿ ಸರಕುಲೆನ ಲೈವ್ ಮಾರ್ಕೆಟ್ ಬೆಲೆ",
    fertilizerRatesDesc: "ಈತ ಗೊಬ್ಬರ ದರ ಮತ್ತು ಸಬ್ಸಿಡಿ ಮಾಹಿತಿ",
    pesticideRatesDesc: "ಔಷಧಿ ದರ ಮತ್ತು ಸಕ್ರಿಯ ಘಟಕ",
    farmingEquipmentDesc: "ಕೃಷಿ ಉಪಕರಣ ಮತ್ತು ಯಂತ್ರ ಬೆಲೆ",
    cropCareTitle: "ಬೆಳೆ ಆರೈಕೆ ಮಾರ್ಗದರ್ಶಿ",
    cropCareSubtitle: "ಬೆಳೆ ಆರೈಕೆ ಸಲಹೆ",
    overview: "ಅವಲೋಕನ", season: "ಕಾಲ", temperature: "ಉಷ್ಣತೆ", rainfall: "ಮಳೆ",
    fertilizers: "ಗೊಬ್ಬರ", pesticides: "ಔಷಧಿ", diseases: "ರೋಗ",
    growthStages: "ಬೆಳವಣಿಗೆ ಹಂತ", generalTips: "ಸಾಮಾನ್ಯ ಸಲಹೆ",
    selectCropToStart: "ಬೆಳೆ ಆರಾನೆ",
    selectCropDescription: "ವಿವರ ನೋಡಂದ ಬೆಳೆ ಆರಾನೆ.",
    selectCrop: "ಬೆಳೆ ಆರಾನೆ", cropInfo: "ಬೆಳೆ ಮಾಹಿತಿ", soilType: "ಮಣ್ಣಿನ ಪ್ರಕಾರ",
    phRange: "pH ವ್ಯಾಪ್ತಿ", scientificName: "ವೈಜ್ಞಾನಿಕ ಪೇರ್",
    fertilizerRecommendations: "ಗೊಬ್ಬರ ಸಲಹೆ", pesticideRecommendations: "ಔಷಧಿ ಸಲಹೆ",
    diseasePrevention: "ರೋಗ ತಡೆ",
    dosage: "ಪ್ರಮಾಣ", applicationMethod: "ವಿಧಾನ", timing: "ಸಮಯ",
    npkRatio: "NPK ಅನುಪಾತ", type: "ಪ್ರಕಾರ", activeingredient: "ಸಕ್ರಿಯ ಘಟಕ",
    targetPests: "ಗುರಿ ಕೀಟ", waitingPeriod: "ನಿರೀಕ್ಷಣಾ ಅವಧಿ",
    biopesticide: "ಜೈವಿಕ ಔಷಧಿ", bioFertilizer: "ಜೈವಿಕ ಗೊಬ್ಬರ",
    fungal: "ಶಿಲೀಂಧ್ರ", bacterial: "ಬ್ಯಾಕ್ಟೀರಿಯಾ", viral: "ವೈರಲ್",
    nematode: "ನೆಮಟೋಡ್", severity: "ತೀವ್ರತೆ"
  }
};
...
const commodityNameMap: Record<string, Partial<Record<Language, string>>> = {
  "Onion": { hi: "प्याज", mr: "कांदा", gu: "ડુંગળી", te: "ఉల్లిపాయ" },
  "Onion (Nashik Red)": { hi: "प्याज (नासिक लाल)", mr: "कांदा (नाशिक लाल)", gu: "ડુંગળી (નાસિક લાલ)", te: "ఉల్లిపాయ (నాసిక్ రెడ్)" },
  "Wheat (Sharbati)": { hi: "गेहूं (शरबती)", mr: "गहू (शरबती)", gu: "ઘઉં (શરબતી)", te: "గోధుమ (శర్బతీ)" },
